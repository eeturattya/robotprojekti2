...
Command for instant usage: robot --variable BROWSER:chromium --variable HEADLESS:True smoke.robot
...
- Run headless robot --variable BROWSER:chromium --variable HEADLESS:True smoke.robot
